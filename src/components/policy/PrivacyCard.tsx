      ...
      <Container>
        <Wrapper>
          ...
          <Content>
            ...
            「개인정보 보호법」 제30조에 따라 이용자의 개인정보를 보호하고 이와
            관련된 고충을 신속하고 원활하게 처리할 수 있게 하도록 아래와 같이
            개인정보 처리 방침을 명시하며, 이용자의 권익 보호에 최선을 다할
            것입니다.
          </Content>
          <Content>
            본 개인정보 처리 방침은 'ssafymate'의 개인 이용약관 및 기업 이용약관
            제2조에 정의된 “서비스”에 적용되며 아래의 내용을 포함합니다.
          </Content>
          <ListWrapper>
            <List>제1조 [개인정보의 처리 목적]</List>
            <List>제2조 [개인정보의 처리 및 보유 기간]</List>

            <List>제3조 [정보 주체의 권리, 의무 및 행사방법]</List>
            <List>제4조 [처리하는 개인정보 항목]</List>

            <List>제5조 [개인정보의 파기]</List>
            <List>제6조 [개인정보의 안전성 확보 조치]</List>
            <List>
          ...
          <Content>
            싸피메이트는 필요한 한도 내에서 최소한의 개인정보를 수집하며, 수집한
            개인정보는 다음의 목적을 위해 활용합니다.
          </Content>
          <ThirdHead>1. 홈페이지 회원가입 및 관리</ThirdHead>
          <Content>
            회원제 서비스 이용에 따른 본인 확인 및 회원 가입 의사 확인, 회원
            자격 유지, 회원 자격 관리, 서비스 부정 이용 및 비인가 사용 방지 등을
            목적으로 개인정보를 처리합니다.
          </Content>
          <ThirdHead>2. 재화 또는 서비스 제공</ThirdHead>
          <Content>
            서비스 제공, 콘텐츠 제공, 맞춤 서비스 제공, 본인인증을 목적으로
            개인정보를 처리합니다.
          </Content>
          <SubHead>제2조 [개인정보의 처리 및 보유 기간]</SubHead>
          <Content>
            싸피메이트는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
            개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서
            개인정보를 처리·보유합니다.
          </Content>
          <Content>개인정보 처리 및 보유 기간은 다음과 같습니다.</Content>
          <ListWrapper>
            <List>
              온라인/모바일 서비스 제공을 위해 수집한 회원가입 정보: 회원가입
              3년 후까지
            </List>
            <List>
              홈페이지 회원가입 및 관리와 관련한 개인정보는 수집.이용에 관한
              동의일로부터 3년 후까지 위 이용목적을 위하여 보유.이용됩니다.
            </List>
            <List>보유근거 : 회원정보를 통한 서비스 제공 </List>
            <List>
          ...
          <Content>
            6. 싸피메이트는 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
          ...
          <ListWrapper>
            <List>홈페이지 회원가입 및 관리</List>
            <List>
              필수항목 : 이메일, 비밀번호, 이름, 자기소개, 희망 직무1, SSAFY
              교육생 정보, 서비스 이용 기록, 쿠키
            </List>
            <List>
              선택항목 : 희망 직무2, 공통 프로젝트, 특화 프로젝트, 프로필
              이미지, SNS url
            </List>
          </ListWrapper>
          <SubHead>제5조 [개인정보의 파기]</SubHead>
          <Content>
            싸피메이트는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가
          ...
          <Content>보존하는 개인정보 항목 : 이메일, 학번, 이름 등</Content>
          <Content>개인정보 파기의 절차 및 방법은 다음과 같습니다.</Content>
          <ThirdHead>1. 파기절차</ThirdHead>
          <Content>
            싸피메이트는 파기 사유가 발생한 개인정보를 선정하고 파기합니다.
          </Content>
          <ThirdHead>2. 파기방법</ThirdHead>
          <Content>
          ...
          <Content>
            싸피메이트 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고
            있습니다.
          </Content>
          <ThirdHead>1. 개인정보의 암호화</ThirdHead>
          <Content>
          ...
          <ThirdHead>2. 접속기록의 보관 및 위변조 방지</ThirdHead>
          <Content>
          ...
          <ThirdHead>3. 개인정보에 대한 접근 제한</ThirdHead>
          <Content>
