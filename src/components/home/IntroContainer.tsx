...
const SERVICE_INTRODUCTION_LIST: ServiceIntroductionType[] = [
  {
    ...
    imgUrl: '/images/home/pc-team-list-sample-img.png',
  },
  {
    id: 2,
    headText: '팀 상세 정보',
    ...
    imgUrl: '/images/home/pc-team-info-sample-img.png',
  },
  {
    id: 3,
    headText: '교육생 공고',
    ...
    imgUrl: '/images/home/pc-user-list-sample-img.png',
  },
  {
    id: 4,
    headText: '교육생 상세 정보',
    ...
    imgUrl: '/images/home/pc-user-info-sample-img.png',
  },
];

const MOBILE_SERVICE_INTRODUCTION_LIST: MobileServiceIntroductionType[] = [
  {
    id: 1,
    headText: '반응형 웹',
    ...
    smallImg: {
      imgUrl: '/images/home/mobile-team-list-sample-img_small.png',
      width: 340,
    },
    mediumImg: {
      imgUrl: '/images/home/mobile-team-list-sample-img_medium.png',
      width: 390,
    },
  },
  {
    ...
    smallImg: {
      imgUrl: '/images/home/mobile-chatting-sample-img_small.png',
      width: 580,
    },
    mediumImg: {
      imgUrl: '/images/home/mobile-chatting-sample-img_medium.png',
      width: 780,
    },
  },
];
    ...
    <Container id="intro-container">
      ...
      {MOBILE_SERVICE_INTRODUCTION_LIST.map((introduction) => (
        <MobileServiceIntroSection
          ...
          subHeadText={introduction.subHeadText}
          descriptionText={introduction.descriptionText}
          smallImg={introduction.smallImg}
          mediumImg={introduction.mediumImg}
          reversed={introduction.id % 2 === 0 ? true : false}
        />
      ))}
    </Container>
