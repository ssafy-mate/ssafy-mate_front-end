...
export const authHandlers = [
  // 회원 가입 1단계 교육생 인증
  rest.get(
    'http://i6a402.p.ssafy.io:8081/api/user/sign-up/verification/ssafy',
  ...
  rest.get(
    'http://i6a402.p.ssafy.io:8081/api/user/sign-up/verification/email',
    async (request, response, context) => {
  ...
  // 회원가입 3단계
  rest.post(
    'http://i6a402.p.ssafy.io:8081/api/user',
    async (request: any, response, context) => {
