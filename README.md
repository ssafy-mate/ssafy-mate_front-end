...
| :------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :-----------: |
| `v1.2.6` | - 채팅 페이지 로직 수정<br />- 웹 성능 최적화(Code Splitting 적용)<br />                                                                                                                                                                                                                                                                                                        |   22.03.17.   |
...
|                                              웹 성능 최적화 전                                              |                                     웹 성능 최적화 후 (22.03.16. 기준)                                     |
| :---------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------: |
...
> 위의 작업들을 통해 Performance Score 62점 → 83점으로 개선, Speed Index 속도 3.5초 → 1.5초로 개선
