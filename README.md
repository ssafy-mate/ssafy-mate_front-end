...
|  이름  |      역할       | 개발 내용                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| :----: | :-------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 조원빈 | Back-end & 팀장 | - DB 설계<br />- Spring Data JPA 세팅<br />&nbsp;&nbsp;&nbsp;&nbsp;- 채팅 도메인 개발<br />&nbsp;&nbsp;&nbsp;&nbsp;- 로그인 도메인 개발<br />- TypeScript, Nest.js와 Socket.io를 이용한 실시간 채팅 서버 구현<br />&nbsp;&nbsp;&nbsp;&nbsp;- 웹소켓 연결<br />&nbsp;&nbsp;&nbsp;&nbsp;- 1대1 실시간 채팅 구현<br />- JWT를 이용한 토큰 생성 구현<br />- 채팅 서버 EC2 배포<br />- crontab 이용한 Linux mysql DB 백업 스케줄러 작동<br />- 'www.ssafymate.site' 도메인 적용                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| 박정환 |    Front-end    | - 'SSAFY MATE' 서비스 기획<br />- 서비스 메인 홈 페이지 개발<br />- 팀 공고, 교육생 공고 정보 제공 서비스 개발<br />&nbsp;&nbsp;&nbsp;&nbsp;- React-Query를 이용해 서버 상태 관리를 진행하여 최신 팀, 교육생 공고 목록들을 사용자에게 제공하고 캐시 데이터를 관리<br />- 팀 공고, 교육생 공고 검색 폼 구현<br />&nbsp;&nbsp;&nbsp;&nbsp;- React-Query를 이용해 사용자가 입력한 검색 폼에 해당하는 맞춤 정보를 서버에 요청 후 그에 해당하는 공고 리스트만 사용자에게 제공<br />- 팀 생성, 수정, 삭제, 탈퇴 서비스 구현<br />&nbsp;&nbsp;&nbsp;&nbsp;- Redux를 이용해 팀 데이터 상태를 관리하고 Redux-Saga를 비동기 처리를 통한 팀 생성, 수정, 삭제, 탈퇴 서비스 구현<br />- 받은 제안, 보낸 요청 서비스 구현<br />&nbsp;&nbsp;&nbsp;&nbsp;- React-Query를 이용한 서버 상태 관리를 통해 받은 제안 및 보낸 요청 목록 정보들을 사용자들에게 제공하고 그에 대한 응답 처리까지 구현<br />- 팀 합류 요청 및 팀 지원 요청 서비스 구현<br />- 팀, 교육생 공고 목록 페이지, 상세 정보 페이지의 Skeleton UI 구현<br />&nbsp;&nbsp;&nbsp;&nbsp;- Skeleton UI 구현을 통해 사용자가 체감하는 페이지 로딩 시간을 줄여 더 나은 UX를 사용자에게 제공<br />- 검색엔진 최적화(SEO) 작업<br />&nbsp;&nbsp;&nbsp;&nbsp;- SEO를 높이기 위해 Meta Data들을 설정하고 체계화된 Heading 처리 및 시멘틱 마크업 사용을 통해 개발<br />- 404 Not Found 페이지 구현<br />- Media Query를 이용한 반응형 UI 설계<br />- Mock Service Worker를 이용해 목업 API 구현하여 백엔드 API 설계 이전 API 테스팅 진행 |
| 소정은 |    Front-end    | - Emotion을 이용한 컴포넌트 스타일링<br />- Media Query를 이용한 반응형 UI 설계<br />&nbsp;&nbsp;&nbsp;&nbsp;- MUI를 이용해 모바일, 태블릿 등의 뷰포트에 따른 채팅 목록 Drawer 적용<br />- Custom hook을 이용한 채팅 입력 상태 관리<br />- Socket.io를 이용한 WebRTC 채팅 구현<br />&nbsp;&nbsp;&nbsp;&nbsp;- 1:1 실시간 채팅 구현, 메시지 주고 받기<br />&nbsp;&nbsp;&nbsp;&nbsp;- Socket의 namespace를 나누어 사용자가 타인의 채팅방에 접속하는 것 제한<br />&nbsp;&nbsp;&nbsp;&nbsp;- Socket으로 로그인, 로그아웃 상태를 전달해 접속 중인 사용자의 온라인 상태 동기화<br />- SWR을 이용한 채팅 목록, 채팅 내역 상태 관리 및 비동기 API 처리<br />&nbsp;&nbsp;&nbsp;&nbsp;- 채팅 내역 스크롤 이동에 따른 데이터 페이징 API 처리, 무한 스크롤링 구현<br />- Mock Service Worker를 이용해 목업 API 구현하여 백엔드 API 설계 이전 API 테스팅 진행                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| 이여진 |    Front-end    | - 회원가입 서비스 개발<br />&nbsp;&nbsp;&nbsp;&nbsp;- React-hook-form 을 이용한 회원가입 form 관리<br />&nbsp;&nbsp;&nbsp;&nbsp;- 이메일 인증을 통한 회원가입 구현<br />- 로그인<br />&nbsp;&nbsp;&nbsp;&nbsp;- Redux, Redux Saga를 통한 회원 정보 상태 관리<br />- 회원 정보 수정 서비스 개발<br />&nbsp;&nbsp;&nbsp;&nbsp;- React custom hook 사용<br />&nbsp;&nbsp;&nbsp;&nbsp;- Redux, Redux-Saga를 통한 회원 정보 상태 관리<br />- Redux를 통한 전역 Alert 서비스 개발<br />- 아이디찾기, 비밀번호 재설정 서비스 개발<br />- 입력값에 대한 유효성 검사를 통해 불필요한 통신 최소화<br />- Emotion을 활용한 컴포넌트 스타일링<br />- 미디어 쿼리를 이용한 반응형 구현<br />- Mock Service Worker를 이용해 목업 API 구현하여 백엔드 API 설계 이전 API 테스팅 진행                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
