...
| 박정환 |    Front-end    | - 'SSAFY MATE' 서비스 기획<br />- 서비스 메인 홈 페이지 개발<br />- 팀 공고, 교육생 공고 정보 제공 서비스 개발<br />&nbsp;&nbsp;&nbsp;&nbsp;- React-Query를 이용한 서버 상태 관리를 통해 팀, 교육생 공고 목록 정보들을 제공<br />&nbsp;&nbsp;&nbsp;&nbsp;- React-Query를 이용한 캐시 데이터 관리<br />- 팀 공고, 교육생 공고 검색 폼 구현<br />&nbsp;&nbsp;&nbsp;&nbsp;- React-Query를 이용해 사용자가 입력한 검색 폼에 해당하는 맞춤 정보를 서버에 요청 후 검색 결과 제공<br />- 팀 생성, 수정, 삭제, 탈퇴 서비스 구현<br />&nbsp;&nbsp;&nbsp;&nbsp;- Redux를 이용해 팀 데이터 상태를 관리<br>&nbsp;&nbsp;&nbsp;&nbsp;- Redux-Saga를 비동기 처리를 통한 팀 생성, 수정, 삭제, 탈퇴 서비스 구현<br />- 받은 제안, 보낸 요청 서비스 구현<br />&nbsp;&nbsp;&nbsp;&nbsp;- React-Query를 이용를 받은 제안 및 보낸 요청 목록 정보들을 사용자에게 제공<br />&nbsp;&nbsp;&nbsp;&nbsp;- 요청에 대한 응답 처리 구현<br />- 팀 합류 요청 및 팀 지원 요청 서비스 구현<br />- 팀, 교육생 공고 목록 페이지, 상세 정보 페이지의 Skeleton UI 구현<br />&nbsp;&nbsp;&nbsp;&nbsp;- Skeleton UI를 통해 사용자가 체감하는 로딩 시간을 줄여 더 나은 UX를 제공<br />- 검색엔진 최적화(SEO) 작업<br />&nbsp;&nbsp;&nbsp;&nbsp;- SEO를 높이기 위해 Meta Data들을 설정하고 체계화된 Heading 처리 및 시멘틱 마크업 사용<br />- 404 Not Found 페이지 구현<br />- Media Query를 이용한 반응형 UI 설계<br />- Mock Service Worker를 이용해 목업 API 구현하여 백엔드 API 설계 이전 API 테스팅 진행 |
